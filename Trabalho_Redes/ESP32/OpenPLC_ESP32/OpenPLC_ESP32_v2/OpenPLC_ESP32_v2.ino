...
#define NODE_PIN_D0   23 //Dig Out
#define NODE_PIN_D1   22 //Dig Out
#define NODE_PIN_D2   1  //Dig Out
#define NODE_PIN_D3   18  //Dig Input
#define NODE_PIN_D4   5 //Dig Input
#define NODE_PIN_D5   17 //Dig Input
#define NODE_PIN_D6   32 //Analog In - entrada
#define NODE_PIN_D7   39  //Analog In
#define NODE_PIN_D8   33 //Analog Out - saida
#define NODE_PIN_D9   35 //Analog Out


uint8_t pinMask_DIN[] = { NODE_PIN_D3, NODE_PIN_D4, NODE_PIN_D5 };
uint8_t pinMask_DOUT[] = { NODE_PIN_D0, NODE_PIN_D1, NODE_PIN_D2 };
uint8_t pinMask_AIN[] = { NODE_PIN_D6 };
...
void pinConfig()
{
    ...
    //pinMode(NODE_PIN_D9, OUTPUT);
    
    analogWriteResolution(8);
    //analogReadResolution(8);
    
    //analogReadResolution(NODE_PIN_D6, 8);
    //analogReadResolution(NODE_PIN_D7, 8);
    analogWriteResolution(NODE_PIN_D8, 8);
    //analogWriteResolution(NODE_PIN_D9, 8);
}
